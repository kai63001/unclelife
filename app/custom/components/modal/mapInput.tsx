...
const ModalMapInput = () => {
  ...
  const { databaseId, layer, tableOfDatabase, modalMapInputOpen, workspaceId } =
  ...
  const renderSelection = () => {
    ...
    list = list?.filter((item: any) => {
      return (
        ...
        listObjectTable[item].type !== "people"
      );
    });
      ...
      <DialogContent className="sm:max-w-[800px]">
        <DialogHeader>
          <DialogTitle className="flex items-center">
            Map Fields Input <ArrowRight className="h-4 w-6" /> Notion
            Properties{" "}
          </DialogTitle>
          <DialogDescription>
              ...
              .map((item: any, index: number) => (
                ...
                >
                  {/* <Input
                                ...
                                /> */}
                  <div
                    className="border w-full col-span-2 rounded-md px-3 py-2"
