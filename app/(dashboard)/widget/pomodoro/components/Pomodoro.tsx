...
const PomodoroWidget = ({ data }: any) => {
  ...
  return (
    <div
      className={cn(
        fonts[pomodoro.font || "inter"].className,
        "w-full h-full flex flex-col relative text-black justify-center items-center"
      )}
    >
      <div
        className={
          "z-20 w-full h-full flex flex-col relative text-black justify-center items-center"
        }
      >
        <CustomTimerPomodoro />
        <CountTimerPomodoro />
